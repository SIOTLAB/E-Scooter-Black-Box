...
/*                                                                        */
/*    txm_module_port.h                                 Cortex-M0+/IAR    */
/*                                                           6.1.10       */
/*  AUTHOR                                                                */
/*                                                                        */
...
/* Define the number of MPU entries assigned to the code and data sections.
   On Cortex-M0/M0+, M4, and some M7 parts, there are 8 total entries. ThreadX uses one for access
...
CHAR                            _txm_module_manager_version_id[] =  \
                                    "Copyright (c) Microsoft Corporation. All rights reserved.  *  ThreadX Module Cortex-M0+/IAR Version 6.1.10   *";
