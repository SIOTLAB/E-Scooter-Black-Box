/**
  ******************************************************************************
  * @file    BLEPiano\Src\BLE_Implementation.c
...
static void WriteRequestPianoFunction(uint8_t * att_data, uint8_t data_length);
...
static void NotifyEventPiano(BLE_NotifyEvent_t Event);
...
void BLE_InitCustomService(void) {
  ...
  if(BleManagerAddChar(BLE_InitPianoService())==0)  {
    STBOX1_PRINTF("Error adding Piano Service\r\n");
  }
