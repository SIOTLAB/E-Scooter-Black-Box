...
/**
 *
 * @page BLESensors BLE Firmware example for Sending Sensors' values using BLE
 *
 ...
 *
 * This example implements in the simplest way how to send the Sensors' values to ST BLE Sensor application
