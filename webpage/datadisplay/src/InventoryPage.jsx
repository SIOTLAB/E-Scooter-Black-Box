...
import fetchRidesbyID from './fetchRidesbyID';
      ...
      {isPopupVisible && (
        <div className="popup">
          <div className="popup-content">
            ...
            <div className="notification-item">User: John has been recorded for rough riding!</div>
            <div className="notification-item">10 New users added this week!</div>
